...
export const Route = createFileRoute('/politicas-de-privacidad')({
  head: () => ({
    meta: [
      { title: 'Políticas de Privacidad | LimaCentro' },
      {
        name: 'description',
        content:
          'Políticas de privacidad de LimaCentro: información que recopilamos, uso, cookies y derechos del usuario.',
      },
    ],
  }),
      ...
      <div className="max-w-4xl mx-auto px-4 py-8">
        ...
        <div className="bg-white rounded-lg shadow-md p-8">
          ...
          <div className="prose max-w-none text-gray-600">
            <p className="mb-4">
              <strong>Fecha de entrada en vigor:</strong> 21 de noviembre de
              2025
            </p>
            ...
            <p className="mb-4">
              LimaCentro recopila información para proporcionar y mejorar
              nuestros servicios:
            </p>
            <ul className="list-disc pl-6 mb-4">
              ...
              <li className="mb-2">
                Información de negocios (nombre, dirección, teléfono, sitio web)
              </li>
            ...
            <p className="mb-4">
              ...
              configurar su navegador para rechazar cookies, aunque esto puede
            ...
            <h2 className="text-2xl font-semibold text-gray-900 mt-8 mb-4">
              7. Cambios a las Políticas
            </h2>
            <p className="mb-4">
              Nos reservamos el derecho de actualizar estas políticas.
              Notificaremos cualquier cambio significativo a través de nuestro
            ...
            <p className="mb-4">
              Para preguntas sobre estas políticas de privacidad, contáctenos
              en:
            </p>
            <p className="mb-4">
              Email: privacy@limacentro.pe
              <br />
